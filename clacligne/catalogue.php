        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <select name="categorie" class="form-control">
                    ...
                    <option value="Litérature Fiction" <?= $categorie == "Litérature Fiction" ? 'selected' : '' ?>>Litérature Fiction</option>
                    <option value="Litérature Scientifique" <?= $categorie == "Litérature Scientifique" ? 'selected' : '' ?>>Litérature Scientifique</option>
                    <option value="Litérature Histoire" <?= $categorie == "Litérature Histoire" ? 'selected' : '' ?>>Litérature Histoire</option>
                    <option value="Litérature Poème" <?= $categorie == "Litérature Poème" ? 'selected' : '' ?>>Litérature Poème</option>
