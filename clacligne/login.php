...
// Si l'utilisateur est déjà connecté, rediriger directement vers son espace
if (isset($_SESSION['utilisateurs_id'])) {
    header("Location: espace_membre.php"); // ou admin.php si rôle admin
    exit;
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($utilisateurs && password_verify($password, $utilisateurs['password'])) {
        ...
        $_SESSION['role'] = $utilisateurs['role']; // "admin" ou "utilisateur"
